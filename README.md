...
4. Затем мы удаляем таблицы "patients" и "medicalexam" из нашей бд и создаем их снова, но не включаем в них столбцы "id". Поочередно заполняем таблицы данными, использую копирование данных из таблицы "dataset".5. После импорта данных, добавляем в наши таблицы поле "id" и первичный ключ.
