...
Цветы соответствуют значениям HeartDisease: красный - потвердился, синий - не потвердился. Значки соответствуют FastingBS: ромб - значение 1, круг - значение 0. По оси x - значения артериального давления, по оси y - возраст.
